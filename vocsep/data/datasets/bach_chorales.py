...
from struttura.utils.pianoroll import pianorolls_from_part
import os
...
from struttura.data.datasets.mcma import preprocess_na_to_monophonic, get_mcma_truth_edges, get_edges_mask
